...
if __name__ == '__main__':
    ...
    # reading a black and white 512x512 pictures to label the dots
    img = cv2.imread('images/area.tif')
    ...
    # center the data in zero
    X = (X - 256) / 128.0

    p = nn_model(X, Y, n_h =20, num_iterations = 10000, print_cost=True)
